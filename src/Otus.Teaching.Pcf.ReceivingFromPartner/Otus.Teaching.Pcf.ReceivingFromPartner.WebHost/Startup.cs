...
namespace Otus.Teaching.Pcf.ReceivingFromPartner.WebHost
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<PartnerManagerPromoCodeAdminNotificationQueueConfig>(setup =>
            {
            ...
            services.AddScoped<IRabbitMqPublisher<PartnerManagerPromoCodeAdminNotificationQueueConfig>, RabbitMQPublisher<PartnerManagerPromoCodeAdminNotificationQueueConfig>>();

            services.Configure<GivingCustomerPromoCodeQueueConfig>(setup =>
            {
                setup.Host = Configuration["RabbitMq:Host"];
                setup.UserName = Configuration["RabbitMq:UserName"];
                setup.Password = Configuration["RabbitMq:Password"];
            ...
            services.AddScoped<IRabbitMqPublisher<GivingCustomerPromoCodeQueueConfig>, RabbitMQPublisher<GivingCustomerPromoCodeQueueConfig>>();
